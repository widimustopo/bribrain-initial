...
type RKA struct {
	...
	TargetRka string                 `protobuf:"bytes,3,opt,name=target_rka,json=targetRka,proto3" json:"target_rka,omitempty"`
...
func (x *RKA) GetTargetRka() string {
	if x != nil {
		return x.TargetRka
	}
	return ""
...
var file_rpc_rka_rka_proto_rawDesc = []byte{
	...
	0x72, 0x67, 0x65, 0x74, 0x5f, 0x72, 0x6b, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
